...
package cisco_ios_xr_policy_repository_oper_routing_policy_shadow_sets_mac_active
...
func init() {
	proto.RegisterType((*RplObjectsInfo_KEYS)(nil), "cisco_ios_xr_policy_repository_oper.routing_policy_shadow.sets.mac.active.rpl_objects_info_KEYS")
	proto.RegisterType((*RplObjectsInfo)(nil), "cisco_ios_xr_policy_repository_oper.routing_policy_shadow.sets.mac.active.rpl_objects_info")
}
...
var fileDescriptor_5524f99561c441b5 = []byte{
	...
	0xff, 0xff, 0x1b, 0x08, 0xa6, 0xed, 0xb0, 0x00, 0x00, 0x00,
}
