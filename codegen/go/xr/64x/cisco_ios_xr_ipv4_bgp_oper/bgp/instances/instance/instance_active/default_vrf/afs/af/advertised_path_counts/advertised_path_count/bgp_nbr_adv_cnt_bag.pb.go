...
func (m *BgpNbrAdvCntBag_KEYS) XXX_DiscardUnknown() {
	xxx_messageInfo_BgpNbrAdvCntBag_KEYS.DiscardUnknown(m)
}

var xxx_messageInfo_BgpNbrAdvCntBag_KEYS proto.InternalMessageInfo
...
type BgpNbrAdvCntBag struct {
	MaxPrefixAdvertisedcount uint32   `protobuf:"varint,50,opt,name=max_prefix_advertisedcount,json=maxPrefixAdvertisedcount,proto3" json:"max_prefix_advertisedcount,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}
...
func (m *BgpNbrAdvCntBag) XXX_DiscardUnknown() {
	xxx_messageInfo_BgpNbrAdvCntBag.DiscardUnknown(m)
}

var xxx_messageInfo_BgpNbrAdvCntBag proto.InternalMessageInfo
