...
func (m *IsisShHost_KEYS) XXX_DiscardUnknown() {
	xxx_messageInfo_IsisShHost_KEYS.DiscardUnknown(m)
}

var xxx_messageInfo_IsisShHost_KEYS proto.InternalMessageInfo
...
type IsisShHost struct {
	LocalIsFlag          bool     `protobuf:"varint,50,opt,name=local_is_flag,json=localIsFlag,proto3" json:"local_is_flag,omitempty"`
	HostLevels           string   `protobuf:"bytes,51,opt,name=host_levels,json=hostLevels,proto3" json:"host_levels,omitempty"`
	HostName             string   `protobuf:"bytes,52,opt,name=host_name,json=hostName,proto3" json:"host_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *IsisShHost) XXX_DiscardUnknown() {
	xxx_messageInfo_IsisShHost.DiscardUnknown(m)
}

var xxx_messageInfo_IsisShHost proto.InternalMessageInfo
