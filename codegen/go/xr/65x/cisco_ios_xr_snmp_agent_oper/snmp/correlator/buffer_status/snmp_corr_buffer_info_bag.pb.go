...
func (m *SnmpCorrBufferInfoBag_KEYS) XXX_DiscardUnknown() {
	xxx_messageInfo_SnmpCorrBufferInfoBag_KEYS.DiscardUnknown(m)
}

var xxx_messageInfo_SnmpCorrBufferInfoBag_KEYS proto.InternalMessageInfo
...
func (m *SnmpCorrBufferInfoBag) XXX_DiscardUnknown() {
	xxx_messageInfo_SnmpCorrBufferInfoBag.DiscardUnknown(m)
}

var xxx_messageInfo_SnmpCorrBufferInfoBag proto.InternalMessageInfo
