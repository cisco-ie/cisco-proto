...
func (m *SnmpSysname_KEYS) XXX_DiscardUnknown() {
	xxx_messageInfo_SnmpSysname_KEYS.DiscardUnknown(m)
}

var xxx_messageInfo_SnmpSysname_KEYS proto.InternalMessageInfo

type SnmpSysname struct {
	SystemName           string   `protobuf:"bytes,50,opt,name=system_name,json=systemName,proto3" json:"system_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SnmpSysname) XXX_DiscardUnknown() {
	xxx_messageInfo_SnmpSysname.DiscardUnknown(m)
}

var xxx_messageInfo_SnmpSysname proto.InternalMessageInfo
