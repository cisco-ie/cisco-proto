...
func (m *ArpGmpConfigEntry_KEYS) XXX_DiscardUnknown() {
	xxx_messageInfo_ArpGmpConfigEntry_KEYS.DiscardUnknown(m)
}

var xxx_messageInfo_ArpGmpConfigEntry_KEYS proto.InternalMessageInfo
...
type ArpGmpConfigEntry struct {
	...
	HardwareAddress      string   `protobuf:"bytes,51,opt,name=hardware_address,json=hardwareAddress,proto3" json:"hardware_address,omitempty"`
	EncapsulationType    string   `protobuf:"bytes,52,opt,name=encapsulation_type,json=encapsulationType,proto3" json:"encapsulation_type,omitempty"`
	EntryType            string   `protobuf:"bytes,53,opt,name=entry_type,json=entryType,proto3" json:"entry_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
