...
func (m *CdpInterface_KEYS) XXX_DiscardUnknown() {
	xxx_messageInfo_CdpInterface_KEYS.DiscardUnknown(m)
}

var xxx_messageInfo_CdpInterface_KEYS proto.InternalMessageInfo
...
func (m *CdpInterface) XXX_DiscardUnknown() {
	xxx_messageInfo_CdpInterface.DiscardUnknown(m)
}

var xxx_messageInfo_CdpInterface proto.InternalMessageInfo
