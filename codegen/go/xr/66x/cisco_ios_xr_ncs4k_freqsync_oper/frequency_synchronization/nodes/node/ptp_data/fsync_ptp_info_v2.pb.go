...
package cisco_ios_xr_ncs4k_freqsync_oper_frequency_synchronization_nodes_node_ptp_data
...
func init() {
	proto.RegisterType((*FsyncPtpInfoV2_KEYS)(nil), "cisco_ios_xr_ncs4k_freqsync_oper.frequency_synchronization.nodes.node.ptp_data.fsync_ptp_info_v2_KEYS")
	proto.RegisterType((*FsyncBagQl)(nil), "cisco_ios_xr_ncs4k_freqsync_oper.frequency_synchronization.nodes.node.ptp_data.fsync_bag_ql")
	proto.RegisterType((*FsyncBagSpInfo)(nil), "cisco_ios_xr_ncs4k_freqsync_oper.frequency_synchronization.nodes.node.ptp_data.fsync_bag_sp_info")
	proto.RegisterType((*FsyncPtpInfoV2)(nil), "cisco_ios_xr_ncs4k_freqsync_oper.frequency_synchronization.nodes.node.ptp_data.fsync_ptp_info_v2")
}
...
var fileDescriptor_442056b9b480ddae = []byte{
	...
	0x1f, 0xc9, 0x61, 0xc8, 0x46, 0x6a, 0x0a, 0x91, 0x80, 0xb2, 0x0a, 0xb8, 0x48, 0x25, 0x2c, 0xe2,
	...
	0xa7, 0x69, 0xeb, 0x77, 0x00, 0x00, 0x00, 0xff, 0xff, 0xcd, 0xfb, 0xd2, 0x82, 0xb5, 0x04, 0x00,
	0x00,
}
